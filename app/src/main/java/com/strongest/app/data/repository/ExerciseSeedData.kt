 ...
 * muscle group, equipment, type, or add new exercises) and want existing installs
...
val exerciseSeedData: List<Exercise> = listOf(
    ...
    Exercise(
        ...
        MuscleGroup.ABS,
        Equipment.MACHINE,
        "Lying machine crunch loading the upper abs through a guided path.",
        "Lie back on the pad and take hold of the handles beside your shoulders. Hook your feet under the rollers and brace your core. Curl your rib cage toward your pelvis, lifting your shoulders off the pad. Lower under control until your abs are stretched, then repeat.",
        type = ExerciseType.ISOLATION
    ),
    Exercise(
        456,
    ...
    Exercise(
        ...
        MuscleGroup.GLUTES,
        Equipment.MACHINE,
        "Standing machine kickback for glute isolation, one leg at a time.",
